...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", default="./sample_output.json", help="path to input JSON file")
    parser.add_argument("--csv_path", default='./sample_res.csv', help="path to output CSV file")
